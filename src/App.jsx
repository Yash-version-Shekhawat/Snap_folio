...
function App() {
  ...
  <div className='relative body w-[100%] h-[100%] bg-black overflow-x-hidden'>
    <ScrollToTop />
      ...
      <div className="LEFT flex items-center">
        ...
        >
          ...
          {/* Menu Links */}
          <button onClick={() => scrollToSection(second)} className="text-[#D0F56E] text-[1em] md:ml-5">
            A<span className="text-[#ffffff]">bout</span>
          </button>
          <button onClick={() => scrollToSection(third)} className="text-[#D0F56E] text-[1em] md:ml-5">
            S<span className="text-[#ffffff]">ervices</span>
          </button>
          <button onClick={() => scrollToSection(fourth)} className="text-[#D0F56E] text-[1em] md:ml-5">
          ...
          <div className="flex md:hidden flex-col items-center gap-2 mt-[35px]">
            <button className="resume h-[2em] w-[8em] bg-[#E05FE4] rounded-[11px] shadow-md shadow-black p-1 text-[1.1em]">
              Resume
            </button>
            <button className="contact h-[2.35em] w-[10em] bg-[#D0F56E] rounded-[11px] shadow-md shadow-black p-1 text-[1.1em]">
              Contact Me
            </button>
          </div>
        </div>
    ...
    {/*------------------------------------------------------------------------------------------------------------*/}
    <div ref={second} className='second w-screen min-h-[0vw] py-10 px-4 bg-[#ECF5FA]'>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="w-full md:w-3/4">
            {experiences.map((exp, index) => (
              <div key={index} className={`md:grid md:grid-cols-3 flex flex-col gap-2 md:gap-0 ${exp.bg} border-b-[1px] border-[#1e1e1e20] last:border-none p-5 2xl:p-7`}>
    ...
    {/*----------------------------------------------------------------------------------------------------------*/}
    <div ref={third} className='services w-screen min-h-[0vw] p-5 bg-[#282830]'>
    ...
    {/*----------------------------------------------------------------------------------------------------------*/}
    <div ref={fourth} className='w-[100%] flex justify-center h-[32vw] md:h-[12vw] bg-[#ECF5FA] md:py-[1vw] py-[1vw] '>
      <Marquee>
      ...
      <div className='flex items-center flex-col text-center'>
        ...
        <div className='w-full flex flex-col md:flex-row gap-6 md:px-10 mt-[34vw] md:mt-14'>
          <div data-aos="flip-down" className='work_1 md:w-1/2 h-[90vw] md:h-[40vw] relative overflow-hidden rounded-lg'>
            <div className='inner-work bg-cover bg-center transition-transform duration-500 ease-in-out' style={{ backgroundImage: `url(${travel})` }}></div>
            <div className='overlay'>
              <img className='h-[13vw] md:h-[5vw]' src={travel_logo}/>
            </div>
          </div>
          <div data-aos="flip-down" className='work_2 md:w-1/2 h-[90vw] md:h-[40vw] relative overflow-hidden rounded-lg'>
            <div className='inner-work bg-cover bg-center transition-transform duration-500 ease-in-out' style={{ backgroundImage: `url(${bhoogol})` }} ></div>
            <div className='overlay'>
    ...
    {/*----------------------------------------------------------------------------------------------------------*/}
    <div ref={fifth} className='w-[100%] min-h-[0vw] bg-[#282830]  border-[#282830] border-8'>
